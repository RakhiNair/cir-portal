...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('registration', '0012_auto_20160608_0941'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='student',
            name='aums_id',
            field=models.FloatField(max_length=32, unique=True, serialize=False, verbose_name='Aums ID', primary_key=True),
        ),
        migrations.AlterField(
            model_name='student',
            name='branch',
            field=models.FloatField(blank=True, max_length=32, null=True, verbose_name='Branch', validators=[django.core.validators.RegexValidator(regex=b'^[A-Za-z]*$')]),
        ),
        migrations.AlterField(
            model_name='student',
            name='cgpa',
        ...
        migrations.AlterField(
            model_name='student',
            name='curr_course',
            field=models.FloatField(blank=True, max_length=32, null=True, verbose_name='Current Course', validators=[django.core.validators.RegexValidator(regex=b'^[A-Za-z]*$')]),
        ),
        migrations.AlterField(
            model_name='student',
            name='hist_arrears',
        ...
        migrations.AlterField(
            model_name='student',
            name='name',
            field=models.FloatField(max_length=32, null=True, verbose_name='First Name', blank=True),
        ),
        migrations.AlterField(
            model_name='student',
            name='s1',
